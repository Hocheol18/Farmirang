...
public class FieldController {
	...
	@ApiResponses(value = {@ApiResponse(responseCode = "200", description = "텃밭 생성을 성공하였습니다."),
	...
	@ApiResponses(value = {@ApiResponse(responseCode = "200", description = "텃밭 목록을 조회를 성공하였습니다."),
		@ApiResponse(responseCode = "400", description = "잘못된 요청입니다.", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
		@ApiResponse(responseCode = "500", description = "서버 내부 문제입니다.", content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
	})
	...
	@ApiResponses(value = {@ApiResponse(responseCode = "200", description = "텃밭 상세 조회를 성공하였습니다."),
		@ApiResponse(responseCode = "400", description = "잘못된 요청입니다.", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
		@ApiResponse(responseCode = "500", description = "서버 내부 문제입니다.", content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
	})
	...
	@ApiResponses(value = {@ApiResponse(responseCode = "200", description = "산책 등록을 성공하였습니다."),
		@ApiResponse(responseCode = "400", description = "잘못된 요청입니다.", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
		@ApiResponse(responseCode = "500", description = "서버 내부 문제입니다.", content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
	})
	public SuccessResponse<?> removeField(@RequestParam(name = "fieldId") Long fieldId) {
	...
	@PatchMapping("/{userId}/{fieldId}")
	@Operation(summary = "텃밭 수정", description = "입력된 내용으로 산책로를 등록 합니다.")
	@ApiResponses(value = {@ApiResponse(responseCode = "200", description = "산책 등록을 성공하였습니다."),
		@ApiResponse(responseCode = "400", description = "잘못된 요청입니다.", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
		@ApiResponse(responseCode = "500", description = "서버 내부 문제입니다.", content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
	})
	public SuccessResponse<?> modifyField(@Validated @PathVariable FieldModifyRequestDto request, @PathVariable(name = "userId") Integer userId, @PathVariable(name = "fieldId") Long fieldId) {
