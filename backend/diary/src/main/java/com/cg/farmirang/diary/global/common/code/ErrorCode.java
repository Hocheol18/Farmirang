package com.cg.farmirang.diary.global.common.code;
...
public enum ErrorCode {
    ...
    DATA_INTEGRITY_VIOLATION__ERROR(410, "G013", "외래키가 존재하지 않는 경우"),

    EXIST_MANUAL_DIARY(411, "G014", "수동 일지가 이미 존재하는 경우"),
